...
namespace TheArtOfDev.HtmlRenderer.Avalonia
{
    ...
    public class HtmlPanel : HtmlControl
    {
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            if ((_verticalScrollBar.Visibility == ScrollBarVisibility.Hidden && size.Height > htmlHeight) ||
                (_verticalScrollBar.Visibility == ScrollBarVisibility.Visible && size.Height <= htmlHeight))
            {
                _verticalScrollBar.Visibility = _verticalScrollBar.Visibility == ScrollBarVisibility.Visible ? ScrollBarVisibility.Hidden : ScrollBarVisibility.Visible;
                relayout = true;
            }

            if ((_horizontalScrollBar.Visibility == ScrollBarVisibility.Hidden && size.Width > htmlWidth) ||
                (_horizontalScrollBar.Visibility == ScrollBarVisibility.Visible && size.Width <= htmlWidth))
            {
                _horizontalScrollBar.Visibility = _horizontalScrollBar.Visibility == ScrollBarVisibility.Visible ? ScrollBarVisibility.Hidden : ScrollBarVisibility.Visible;
                relayout = true;
            }
        ...
        protected override Size ArrangeOverride(Size bounds)
        {
            ...
            if (_htmlContainer != null)
            {
                ...
                if (_horizontalScrollBar.Visibility == ScrollBarVisibility.Visible)
                {
        ...
        {
            var width = base.HtmlWidth(size) - (_verticalScrollBar.Visibility == ScrollBarVisibility.Visible ? _verticalScrollBar.Width : 0);
        ...
        {
            var height = base.HtmlHeight(size) - (_horizontalScrollBar.Visibility == ScrollBarVisibility.Visible ? _horizontalScrollBar.Height : 0);
